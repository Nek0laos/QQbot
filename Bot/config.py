...
MEMORY_EMBEDDING_MODEL = _memory.get("embedding_model", "BAAI/bge-small-zh-v1.5")
MEMORY_LEXICAL_WEIGHT = float(_memory.get("lexical_weight", 0.18))
MEMORY_RECENCY_WEIGHT = float(_memory.get("recency_weight", 0.04))
